...
// @desc    Access a chat (create or fetch one-on-one)
    ...
    try {
        Chat.find({ users: { $elemMatch: { $eq: req.user._id } } })
            ...
            .then(async (results) => {
                ...
                // Aggregation to count messages in these chats that are NOT read by current user
                // and NOT sent by current user (optional, but usually you don't read your own sent messages as 'unread')
                ...
                // Attach unreadCount to each chat object
